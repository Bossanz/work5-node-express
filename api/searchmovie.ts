...
router.get("/", (req, res) => {
    ...
    conn.query(sql, [title], (err, results: any[], fields) => {
        ...
        results.forEach((row: any) => {
            ...
            const creator = {
                creators_id: row.creators_id,
                creators_name: row.creators_name,
                creators_born: row.creators_born,
                creators_bio: row.creators_bio,
            };
            ...
            if (!movie.creators.find((c: any) => c.creator_id === creator.creators_id)) {
